...
export const nodeType = 'webhook_callback_test';
export const category = 'utility';
export const description = 'Tests webhook callbacks by sending data to a URL';
export const displayName = 'Webhook Callback Test';
export const icon = 'webhook';
